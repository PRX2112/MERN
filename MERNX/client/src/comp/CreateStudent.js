...
export const CreateStudent = () => {
    ...
    const collectData=async()=>{try{let insertData=axios.post('http://localhost:5000/student/signup',{name,email,phone,username,password});}catch(error){console.log(error)}}
  return (
    <div className='App'>
